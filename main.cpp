...
#include <iostream> 
#include <fstream> 
#include "../../SquareAndTriangle/SquareAndTriangle/Utils.h"
#include <cmath> 
#include <glm\glm.hpp> 
...
void setupVertices(void) {    // 36个顶点，12个三角形，组成了放置在原点
    //处的2×2×2立方体
...
void init(GLFWwindow* window) {
    ...
    cubeLocX = 0.0f; cubeLocY = -2.0f; cubeLocZ = 0.0f; // 沿Y轴下移
    //以展示透视
        setupVertices();
}
void display(GLFWwindow* window, double currentTime) {
    ...
    pMat = glm::perspective(1.0472f, aspect, 0.1f, 1000.0f); //  1.0472 radians = 60 degrees
        //  构建视图矩阵、模型矩阵和视图 - 模型矩阵
        vMat = glm::translate(glm::mat4(1.0f), glm::vec3(-cameraX,
            cameraY, -cameraZ));
    mMat = glm::translate(glm::mat4(1.0f), glm::vec3(cubeLocX,
        cubeLocY, cubeLocZ));
    mvMat = vMat * mMat;
