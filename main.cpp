...
ImportedModel myModel("./models/blenderCartoonCar.obj");
...
void init(GLFWwindow* window)
{
	...
	setupVertices();
	shuttleTexture = Utils::loadTexture("blenderCartoonCar.mtl");
}
...
void display(GLFWwindow* window, double currentTime)
{
	...
	mMat = glm::scale(mMat, glm::vec3(0.001f, 0.001f, 0.001f)); // 缩小模型
...
int main(void)
{
	...
	GLFWwindow* window = glfwCreateWindow(600, 600, "ObjLoader", NULL, NULL);
